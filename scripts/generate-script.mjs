...
# SEO対策のルール(重要)
- titleには、検索されやすい具体的なキーワード(固有名詞・数字)を必ず含めること。「〜ベスト3」「もし〜だったら」のような定番の検索意図に合う言い回しにする
- tagsには、検索ボリュームが見込める一般的なキーワード(例:雑学,豆知識)と、その動画固有の具体的キーワード(固有名詞・専門用語)を両方含めること
